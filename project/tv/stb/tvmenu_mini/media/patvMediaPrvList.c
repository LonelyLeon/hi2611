...
medialist_menu_ok_action (void) D_FUNCPOSTFIT
{
    ...
    { 
        /* 播放媒体文件*/
        if(D_OK == p_media_movie_full_screen_show(media_list_data->mediaCurrFolder_utf8, media_list_data->mediaCurrFocus, &media_list_data->mediaFileRset, 0, pvr_movie_fullscreen_hide_handler))
        {
