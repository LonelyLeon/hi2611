...
static PREFIXCONST D_FrameControlDescr POSTCONST ctrl_description_of_pic_list_menu_window[]=
{
	// [0]canvas
...
extern D_Result	pic_list_menu_window_init  (D_Frame *init) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_pic_list_menu_window[34];
D_Frame pic_list_menu_window = {
	run_ctrls_pic_list_menu_window, 
	ctrl_description_of_pic_list_menu_window, 
	pic_list_menu_window_init, 
};
