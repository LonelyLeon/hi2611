...
static PREFIXCONST D_CtrlAttribute POSTCONST GUID_pause_normal = { -1, atv_IMG_ID_media_movie_play, -1, NULL, };
...
static PREFIXCONST D_CtrlAttribute POSTCONST GUID_play_normal = { -1, atv_IMG_ID_media_movie_pause, -1, NULL, };
...
atv_media_pvr_full_window_init (D_Frame *frm) D_FUNCPOSTFIT
{
    ...
    if(vis)
    {
        ...
        media_pvr_full_data->mediaFullPvrWin.x = 0; 
        media_pvr_full_data->mediaFullPvrWin.y = 0; 
	media_pvr_full_data->mediaFullPvrWin.w = -1; //media_pvr_full_data->vis_full_win->rect.w;
        media_pvr_full_data->mediaFullPvrWin.h = -1; //media_pvr_full_data->vis_full_win->rect.h;
