/* !!!!!!!!!!!!!DO NOT MODIFY THIS FILE!!!!!!!!!!!!! 
	...
	on computer "PRLIUS"
	update/create time:	2019-02-22 15:59:53
...
static PREFIXCONST D_FrameControlDescr POSTCONST ctrl_description_of_atv_player_window[]=
{
	// [0]canvas
...
extern D_Result	atv_player_window_init  (void) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_atv_player_window[1];
D_Frame atv_player_window = {
	run_ctrls_atv_player_window, 
	ctrl_description_of_atv_player_window, 
	NULL, 
};
