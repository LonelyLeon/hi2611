...
static PREFIXCONST D_FrameControlDescr POSTCONST ctrl_description_of_image_mode_window[]=
{
	// [0]canvas
...
extern D_Result	image_mode_window_init  (D_Frame *init) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_image_mode_window[2];
D_Frame image_mode_window = {
	run_ctrls_image_mode_window, 
	ctrl_description_of_image_mode_window, 
	image_mode_window_init, 
};
