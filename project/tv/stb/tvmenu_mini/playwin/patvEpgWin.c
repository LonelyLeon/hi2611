...
#define LIST_ROW_CNT_CHAN       (5)         /**@brief频道列表框行数*/
#define LIST_ROW_CNT_EVENT      (5)         /**@brief事件列表框行数*/
...
epg_evt_update_list (D_Visual *vis) D_FUNCPOSTFIT
{
    ...
    /*取得预定图标*/
    blueimg = d_gui_get_image(atv_IMG_ID_atv_IMG_ID_BUTTON_Blue);
    greenimg = d_gui_get_image(atv_IMG_ID_atv_IMG_ID_BUTTON_Green);
