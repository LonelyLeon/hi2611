...
static PREFIXCONST D_FrameControlDescr POSTCONST ctrl_description_of_video_mode_window[]=
{
	// [0]canvas
...
extern D_Result	video_mode_window_init  (D_Frame *init) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_video_mode_window[2];
D_Frame video_mode_window = {
	run_ctrls_video_mode_window, 
	ctrl_description_of_video_mode_window, 
	video_mode_window_init, 
};
