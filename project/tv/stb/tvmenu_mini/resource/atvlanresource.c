...
static PREFIXCONST char POSTCONST atv_IDS_HDMI1_0[]="VGA";
static PREFIXCONST char POSTCONST atv_IDS_HDMI1_1[]="VGA";

static PREFIXCONST char POSTCONST atv_IDS_HDMI2_0[]="HDMI";
static PREFIXCONST char POSTCONST atv_IDS_HDMI2_1[]="HDMI";
...
static PREFIXCONST char POSTCONST atv_IDS_NO_USB_0[] = "No device";
static PREFIXCONST char POSTCONST atv_IDS_NO_USB_1[] = "没有设备！";

static PREFIXCONST char POSTCONST atv_IDS_USB_CONNECT_0[] = "Device Connect";
static PREFIXCONST char POSTCONST atv_IDS_USB_CONNECT_1[] = "设备已插入！";

static PREFIXCONST char POSTCONST atv_IDS_USB_DIS_CONNECT_0[] = "Device DisConnect";
static PREFIXCONST char POSTCONST atv_IDS_USB_DIS_CONNECT_1[] = "设备已移出！";
...
static PREFIXCONST char POSTCONST atv_IDS_SAVE_PROGROM_0[]="Program is being saved,please hold on...";
static PREFIXCONST char POSTCONST atv_IDS_SAVE_PROGROM_1[]="正在保存节目，请稍后...";

static PREFIXCONST char POSTCONST atv_IDS_STAND_BY_0[]="Stand by in seconds";
static PREFIXCONST char POSTCONST atv_IDS_STAND_BY_1[]="秒之后待机";

static PREFIXCONST char POSTCONST atv_IDS_KEY_CANCEL_0[]="Press any key to cancel";
static PREFIXCONST char POSTCONST atv_IDS_KEY_CANCEL_1[]="按任意键取消";

static PREFIXCONST char POSTCONST atv_IDS_BLUE_SCREEN_0[]="Blue Screen";
static PREFIXCONST char POSTCONST atv_IDS_BLUE_SCREEN_1[]="蓝屏";

static PREFIXCONST char POSTCONST atv_IDS_BLACK_SCREEN_0[]="Black Screen";
static PREFIXCONST char POSTCONST atv_IDS_BLACK_SCREEN_1[]="黑屏";
...
static PREFIXCONST char POSTCONST atv_IDS_WIFI_DISPLAY_1[] = "手机同屏";

static PREFIXCONST char POSTCONST atv_IDS_DEVICE_NAME_0[] = "Device Name :";
...
static PREFIXCONST char POSTCONST atv_IDS_AIRPLAY_0[]="Airplay";
static PREFIXCONST char POSTCONST atv_IDS_AIRPLAY_1[]="Airplay";

static PREFIXCONST char POSTCONST atv_IDS_LIULINK_0[] = "Art Frame";
static PREFIXCONST char POSTCONST atv_IDS_LIULINK_1[] = "艺术相框";

static PREFIXCONST char POSTCONST IDS_GET_NET_TIME_0[] = "Getting the time from the internet.";
static PREFIXCONST char POSTCONST IDS_GET_NET_TIME_1[] = "正在获取网络时间";

static PREFIXCONST char POSTCONST IDS_THEREIS_NOPROG_0[] = "Please public the program.";
static PREFIXCONST char POSTCONST IDS_THEREIS_NOPROG_1[] = "等待节目加载";

static PREFIXCONST char POSTCONST IDS_CONNECTING_NET_0[] = "Connecting the internet, please waiting...";
static PREFIXCONST char POSTCONST IDS_CONNECTING_NET_1[] = "正在启动网络功能，请稍等";

static PREFIXCONST char POSTCONST IDS_WIFI_FAILED_0[] = "Failed, please check the WIFI is available.";
static PREFIXCONST char POSTCONST IDS_WIFI_FAILED_1[] = "启动失败！无WIFI设备或WIFI设备损坏，请检查！";

static PREFIXCONST char POSTCONST IDS_SET_WIFI_0[] = "Please press the RED button to connect WIFI.";
static PREFIXCONST char POSTCONST IDS_SET_WIFI_1[] = "请设置WIFI连接，请按红键";

static PREFIXCONST char POSTCONST atv_IDS_JANUARY_0[] = "Jan.";
static PREFIXCONST char POSTCONST atv_IDS_JANUARY_1[] = "01月";

static PREFIXCONST char POSTCONST atv_IDS_FEBRUARY_0[] = "Feb.";
static PREFIXCONST char POSTCONST atv_IDS_FEBRUARY_1[] = "02月";

static PREFIXCONST char POSTCONST atv_IDS_MARCH_0[] = "Mar.";
static PREFIXCONST char POSTCONST atv_IDS_MARCH_1[] = "03月";

static PREFIXCONST char POSTCONST atv_IDS_APRIL_0[] = "Apr.";
static PREFIXCONST char POSTCONST atv_IDS_APRIL_1[] = "04月";

static PREFIXCONST char POSTCONST atv_IDS_MAY_0[] = "May.";
static PREFIXCONST char POSTCONST atv_IDS_MAY_1[] = "05月";

static PREFIXCONST char POSTCONST atv_IDS_JUNE_0[] = "Jun.";
static PREFIXCONST char POSTCONST atv_IDS_JUNE_1[] = "06月";

static PREFIXCONST char POSTCONST atv_IDS_JULY_0[] = "Jul.";
static PREFIXCONST char POSTCONST atv_IDS_JULY_1[] = "07月";

static PREFIXCONST char POSTCONST atv_IDS_AUGUST_0[] = "Aug.";
static PREFIXCONST char POSTCONST atv_IDS_AUGUST_1[] = "08月";

static PREFIXCONST char POSTCONST atv_IDS_SEPTEMBER_0[] = "Sept.";
static PREFIXCONST char POSTCONST atv_IDS_SEPTEMBER_1[] = "09月";

static PREFIXCONST char POSTCONST atv_IDS_OCTOBER_0[] = "Oct.";
static PREFIXCONST char POSTCONST atv_IDS_OCTOBER_1[] = "10月";

static PREFIXCONST char POSTCONST atv_IDS_NOVEMBER_0[] = "Nov.";
static PREFIXCONST char POSTCONST atv_IDS_NOVEMBER_1[] = "11月";

static PREFIXCONST char POSTCONST atv_IDS_DECEMBER_0[] = "Dec.";
static PREFIXCONST char POSTCONST atv_IDS_DECEMBER_1[] = "12月";

static PREFIXCONST char POSTCONST atv_IDS_ZHILIAN_MAIN_TV_0[] = "Link TV";
static PREFIXCONST char POSTCONST atv_IDS_ZHILIAN_MAIN_TV_1[] = "智联电视";

static PREFIXCONST char POSTCONST atv_IDS_ZHILIAN_IPTV_0[] = "IPTV";
static PREFIXCONST char POSTCONST atv_IDS_ZHILIAN_IPTV_1[] = "IPTV";

static PREFIXCONST char POSTCONST atv_IDS_ZHILIAN_IPTV_TEXT_0[] = "Click to enter live broadcast";
static PREFIXCONST char POSTCONST atv_IDS_ZHILIAN_IPTV_TEXT_1[] = "点击进入直播";

static PREFIXCONST char POSTCONST atv_IDS_WIFI_CONNECT_0[]="Connecting";
static PREFIXCONST char POSTCONST atv_IDS_WIFI_CONNECT_1[]="连接中";

static PREFIXCONST char POSTCONST atv_IDS_WIFI_NO_CONNECT_0[]="Disconnect";
static PREFIXCONST char POSTCONST atv_IDS_WIFI_NO_CONNECT_1[]="未连接";

static PREFIXCONST char POSTCONST atv_IDS_WIFI_CONNECTED_0[]="Connected";
static PREFIXCONST char POSTCONST atv_IDS_WIFI_CONNECTED_1[]="已连接";

static PREFIXCONST char POSTCONST atv_IDS_SEC_0[]="S";
static PREFIXCONST char POSTCONST atv_IDS_SEC_1[]="秒";

static PREFIXCONST char POSTCONST atv_IDS_GOTO_LAST_TIME_0[]="Go to last play time (%s) ?";
static PREFIXCONST char POSTCONST atv_IDS_GOTO_LAST_TIME_1[]="跳转到上次播放位置(%s)播放?";

static PREFIXCONST char POSTCONST atv_IDS_STOP_ATV_SCAN_0[]="Do you want to skip ATV tuning, No/Yes ?";
static PREFIXCONST char POSTCONST atv_IDS_STOP_ATV_SCAN_1[]="是否要结束ATV搜索?";
...
static PREFIXCONST char POSTCONST *language_prefix_English[] =
{
    ...
    atv_IDS_SAVE_PROGROM_0,
    atv_IDS_STAND_BY_0,
    atv_IDS_KEY_CANCEL_0,
    atv_IDS_BLUE_SCREEN_0,
    atv_IDS_BLACK_SCREEN_0,
    ...
    atv_IDS_AIRPLAY_0,
    atv_IDS_LIULINK_0,
    IDS_GET_NET_TIME_0,     // IDS_GET_NET_TIME
    IDS_THEREIS_NOPROG_0,       // IDS_THEREIS_NOPROG
    IDS_CONNECTING_NET_0,       // IDS_CONNECTING_NET
    IDS_WIFI_FAILED_0,      // IDS_WIFI_FAILED
    IDS_SET_WIFI_0,     // IDS_SET_WIFI
    atv_IDS_JANUARY_0,      // IDS_JANUARY
    atv_IDS_FEBRUARY_0,     // IDS_FEBRUARY
    atv_IDS_MARCH_0,        // IDS_MARCH
    atv_IDS_APRIL_0,        // IDS_APRIL
    atv_IDS_MAY_0,      // IDS_MAY
    atv_IDS_JUNE_0,     // IDS_JUNE
    atv_IDS_JULY_0,     // IDS_JULY
    atv_IDS_AUGUST_0,       // IDS_AUGUST
    atv_IDS_SEPTEMBER_0,        // IDS_SEPTEMBER
    atv_IDS_OCTOBER_0,      // IDS_OCTOBER
    atv_IDS_NOVEMBER_0,     // IDS_NOVEMBER
    atv_IDS_DECEMBER_0,     // IDS_DECEMBER
    atv_IDS_ZHILIAN_MAIN_TV_0,
    atv_IDS_ZHILIAN_IPTV_0,
    atv_IDS_ZHILIAN_IPTV_TEXT_0,
    atv_IDS_WIFI_CONNECT_0,
    atv_IDS_WIFI_NO_CONNECT_0,
    atv_IDS_WIFI_CONNECTED_0, 
    atv_IDS_SEC_0,
    atv_IDS_GOTO_LAST_TIME_0,
    atv_IDS_STOP_ATV_SCAN_0,
};
...
static PREFIXCONST char POSTCONST *language_prefix_Chinese[] =
{
    ...
    atv_IDS_SAVE_PROGROM_1,
    atv_IDS_STAND_BY_1,
    atv_IDS_KEY_CANCEL_1,
    atv_IDS_BLUE_SCREEN_1,
    atv_IDS_BLACK_SCREEN_1,
    ...
    atv_IDS_AIRPLAY_1,
    atv_IDS_LIULINK_1,
    IDS_GET_NET_TIME_1,     // IDS_GET_NET_TIME
    IDS_THEREIS_NOPROG_1,       // IDS_THEREIS_NOPROG
    IDS_CONNECTING_NET_1,       // IDS_CONNECTING_NET
    IDS_WIFI_FAILED_1,      // IDS_WIFI_FAILED
    IDS_SET_WIFI_1,     // IDS_SET_WIFI
    atv_IDS_JANUARY_1,      // IDS_JANUARY
    atv_IDS_FEBRUARY_1,     // IDS_FEBRUARY
    atv_IDS_MARCH_1,        // IDS_MARCH
    atv_IDS_APRIL_1,        // IDS_APRIL
    atv_IDS_MAY_1,      // IDS_MAY
    atv_IDS_JUNE_1,     // IDS_JUNE
    atv_IDS_JULY_1,     // IDS_JULY
    atv_IDS_AUGUST_1,       // IDS_AUGUST
    atv_IDS_SEPTEMBER_1,        // IDS_SEPTEMBER
    atv_IDS_OCTOBER_1,      // IDS_OCTOBER
    atv_IDS_NOVEMBER_1,     // IDS_NOVEMBER
    atv_IDS_DECEMBER_1,     // IDS_DECEMBER
    atv_IDS_ZHILIAN_MAIN_TV_1,
    atv_IDS_ZHILIAN_IPTV_1,
    atv_IDS_ZHILIAN_IPTV_TEXT_1,
    atv_IDS_WIFI_CONNECT_1,
    atv_IDS_WIFI_NO_CONNECT_1,
    atv_IDS_WIFI_CONNECTED_1,
    atv_IDS_SEC_1,
    atv_IDS_GOTO_LAST_TIME_1,
    atv_IDS_STOP_ATV_SCAN_1,
};
