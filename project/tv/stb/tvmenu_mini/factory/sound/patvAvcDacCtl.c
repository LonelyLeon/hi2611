...
static D_Char *show_title_text[2] = {"AVC DAC CTL", "AVC DAC CTL"};
static D_Char *show_button_text[4][2] =
{
    {"CUR_AVC_DAC", "CUR_AVC_DAC"},
    {"AVC_DAC_VALUE_L", "AVC_DAC_VALUE_L"},
    {"AVC_DAC_VALUE_R", "AVC_DAC_VALUE_R"},
};
...
{
    d_av_set_avc_ctrl_l((D_U32)(avc_dac_ctl_data->avc_dac_value_1));
    d_av_set_avc_ctrl_r((D_U32)(avc_dac_ctl_data->avc_dac_value_2));
    return D_OK;
}
...
{
    //p_tvconf_set_avc_dac_ctl_set_param(&avc_dac_ctl_data->param, p_vip_get_dbinput(avc_dac_ctl_data->input), avc_ctrl_type);
    return D_OK;
}
...
set_avc_dac_ctl_data(D_ID id, D_Bool flag) D_FUNCPOSTFIT
{
    ...
    switch(id)
    {
        ...
        case ID_AVC_DAC_CTL_BUTTON_3:
            avc_dac_ctl_data->avc_dac_value_2 = set_avc_dac_ctl_value(avc_dac_ctl_data->avc_dac_value_2, flag);
...
get_set_of_avc_dac_ctl(void) D_FUNCPOSTFIT
{
    ...
    //avc_dac_ctl_data->cur_avc_dac = D_MIN(avc_dac_ctl_data->cur_avc_dac, AVC_LEVEL_NUM);

    //p_tvconf_get_avc_dac_ctl_set_param(&avc_dac_ctl_data->param, p_vip_get_dbinput(avc_dac_ctl_data->input), avc_ctrl_type);

    avc_dac_ctl_data->avc_dac_value_1 = d_av_get_dac_ctrl_l();
    avc_dac_ctl_data->avc_dac_value_2 = d_av_get_dac_ctrl_r();
