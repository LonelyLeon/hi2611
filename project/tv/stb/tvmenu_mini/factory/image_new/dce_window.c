...
static PREFIXCONST D_FrameControlDescr POSTCONST ctrl_description_of_dce_window[]=
{
	// [0]canvas
...
extern D_Result	dce_window_init  (D_Frame *init) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_dce_window[9];
D_Frame dce_window = {
	run_ctrls_dce_window, 
	ctrl_description_of_dce_window, 
	dce_window_init, 
};
