/* !!!!!!!!!!!!!DO NOT MODIFY THIS FILE!!!!!!!!!!!!! 
	...
	on computer "PRLIUS"
	update/create time:	2019-05-10 16:13:42
...
//////////////////////////////////////////////////////////////////////////
// predefined macros 
#define	ID_POPOFF_BUTTON_ON	1
#define	ID_POPOFF_BUTTON_OFF	2
#define	ID_POPOFF_GROUP_TIME	3
#define	ID_POPOFF_INPUT_HOUR	4
#define	ID_POPOFF_LABLE_DIAN	5
#define	ID_POPOFF_INPUT_MINUTE	6
...
//////////////////////////////////////////////////////////////////////////
// definition of [5]{D_CTRL_LABEL}	"ID_POPOFF_LABLE_DIAN"
static PREFIXCONST D_FrameCtrlDescr POSTCONST GUID_c49fb715_03e3cc7={{&GUID_c49fb715_03e949, NULL, NULL, }, 1, };

//////////////////////////////////////////////////////////////////////////
// definition of [6]{D_CTRL_INPUT}	"ID_POPOFF_INPUT_MINUTE"
...
static PREFIXCONST D_FrameControlDescr POSTCONST ctrl_description_of_atv_pop_power_off_window[]=
{
	// [0]canvas
	{D_CTRL_WINDOW, -1, 230, 400, 0, 260, 140, 0, -1, (D_FrameCtrlDescr*)&GUID_c40d74e3_09c63cb, },
	// [1]ID_POPOFF_BUTTON_ON
	{D_CTRL_BUTTON, 0, 17, 30, 295, 94, 32, 30, -1, (D_FrameCtrlDescr*)&GUID_c4a027ab_04e67ee, },
	// [2]ID_POPOFF_BUTTON_OFF
	{D_CTRL_BUTTON, 0, 17, 78, 295, 94, 32, 30, -1, (D_FrameCtrlDescr*)&GUID_c4a0288c_1e471ab, },
	// [3]ID_POPOFF_GROUP_TIME
	{D_CTRL_GROUP, 0, 127, 51, 295, 122, 40, 30, -1, (D_FrameCtrlDescr*)&GUID_c4a02c60_167dac, },
	// [4]ID_POPOFF_INPUT_HOUR
	{D_CTRL_INPUT, 0, 136, 53, 295, 36, 36, 30, -1, (D_FrameCtrlDescr*)&GUID_c49fb278_1195f0c, },
	// [5]ID_POPOFF_LABLE_DIAN
	{D_CTRL_LABEL, 0, 175, 53, 295, 26, 36, 30, -1, (D_FrameCtrlDescr*)&GUID_c49fb715_03e3cc7, },
	// [6]ID_POPOFF_INPUT_MINUTE
	{D_CTRL_INPUT, 0, 204, 53, 295, 36, 36, 30, -1, (D_FrameCtrlDescr*)&GUID_c49fb80d_38a6176, },
	{-1}
};

//////////////////////////////////////////////////////////////////////////
// definitions of FRAME entry
extern D_Result	atv_pop_power_off_window_init  (D_Frame *init) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_atv_pop_power_off_window[7];
D_Frame atv_pop_power_off_window = {
	run_ctrls_atv_pop_power_off_window, 
	ctrl_description_of_atv_pop_power_off_window, 
	atv_pop_power_off_window_init, 
};
