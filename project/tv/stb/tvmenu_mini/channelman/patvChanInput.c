...
static D_ImageID NumImgId[10] = {atv_IMG_ID_Num_Zero, atv_IMG_ID_Num_One, atv_IMG_ID_Num_Two,atv_IMG_ID_Num_Three, atv_IMG_ID_Num_Four,atv_IMG_ID_Num_Five, 
								atv_IMG_ID_Num_Six, atv_IMG_ID_Num_Seven, atv_IMG_ID_Num_Eight, atv_IMG_ID_Num_Nine};
