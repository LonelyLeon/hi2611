...
void CheckWordLen(void)
{
	...
	if (argc > 1)
	{
       ...
       */
        ...
        D_DUMP(" size of ishiftvar is %d bits\n", counter);
        ...
        D_DUMP(" size of lshiftvar is %d bits \n", counter);
	...
	{
	case 1:
		D_DUMP(" This system support 32-bits Operation!!!! \n");break;
	case 2:
		D_DUMP(" This system support 64-bits Operation !!!! \n");break;
	case 0:
		D_DUMP(" This system support Operation under 32-bits!!!! \n");break;
	}
}
