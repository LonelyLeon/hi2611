...
D_GUIMenu
atv_image_menu =
    D_GUI_DECL_MENU(&atv_sub_menu_window, atv_image_menu_items, atv_IDS_PICTURE, atv_IMG_ID_image_icon_big, D_CLEAR_NONE);
...
D_GUIMenu
atv_voice_menu =
    D_GUI_DECL_MENU(&atv_sub_menu_window, atv_voice_menu_items, atv_IDS_SOUND, atv_IMG_ID_voice_icon_big, D_CLEAR_NONE);
...
D_GUIMenu
atv_tunning_menu =
    D_GUI_DECL_MENU(&atv_sub_menu_window, atv_tunning_menu_items, atv_IDS_CHANNEL, atv_IMG_ID_tuning_icon_big, D_CLEAR_NONE);
...
atv_function_menu_items[] =
{
    ...
    //D_GUI_MENU_ITEM_RUN(p_atv_wlan_menu_show, D_FALSE, atv_IDS_WIFI_SETTING, -1),
#endif
    D_GUI_MENU_ITEM_RUN(p_atv_blue_screen_show, D_FALSE, atv_IDS_BLUE_SCREEN, -1),
    D_GUI_MENU_ITEM_END()
};
...
D_GUIMenu
atv_function_menu =
    D_GUI_DECL_MENU(&atv_sub_menu_window, atv_function_menu_items, atv_IDS_FUNCTION, atv_IMG_ID_function_icon_big, D_CLEAR_NONE);
...
D_GUIMenu
atv_time_menu =
    D_GUI_DECL_MENU(&atv_sub_menu_window, atv_time_menu_items, atv_IDS_TIME, atv_IMG_ID_time_icon_big, D_CLEAR_NONE);
...
atv_main_menu_items[] =
{
    D_GUI_MENU_ITEM_SUB(&atv_image_menu, D_FALSE, atv_IDS_PICTURE, atv_IMG_ID_image_icon_small),
    D_GUI_MENU_ITEM_SUB(&atv_voice_menu, D_FALSE, atv_IDS_SOUND, atv_IMG_ID_voice_icon_small),
    D_GUI_MENU_ITEM_SUB(&atv_tunning_menu, D_FALSE, atv_IDS_CHANNEL, atv_IMG_ID_tuning_icon_small),
    D_GUI_MENU_ITEM_SUB(&atv_function_menu, D_FALSE, atv_IDS_FUNCTION, atv_IMG_ID_function_icon_small),
//   D_GUI_MENU_ITEM_SUB(&atv_adjust_menu, D_FALSE, atv_IDS_ADJUST, atv_IMG_ID_adjust_icon_small),
    D_GUI_MENU_ITEM_SUB(&atv_time_menu, D_FALSE, atv_IDS_TIME, atv_IMG_ID_time_icon_small),
    D_GUI_MENU_ITEM_END()
};
