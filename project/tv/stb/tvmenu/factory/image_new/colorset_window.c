...
#define	ID_ASE_BUTTON_1	6
#define	ID_ASE_LABEL_1	7
#define	ID_ASE_BUTTON_2	8
#define	ID_ASE_BUTTON_3	9
#define	ID_ASE_LABEL_2	10
#define	ID_ASE_LABEL_3	11
...
static PREFIXCONST D_FrameControlDescr POSTCONST ctrl_description_of_colorset_window[]=
{
	// [0]canvas
...
extern D_Result	colorset_window_init  (D_Frame *init) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_colorset_window[24];
D_Frame colorset_window = {
	run_ctrls_colorset_window, 
	ctrl_description_of_colorset_window, 
	colorset_window_init, 
};
