/* !!!!!!!!!!!!!DO NOT MODIFY THIS FILE!!!!!!!!!!!!! 
	This file is produced/modified by {tianmy}
	on computer "PRTIANMY"
	update/create time:	2015-09-16 14:38:49

	Tool info:
	{
		verion:	3.0.0.6
		build-date:	2015-09-15 16:20:48.843
...
//////////////////////////////////////////////////////////////////////////
// predefined macros 
#define	ID_AVC_DAC_CTL_LABEL_AVC_DAC_CTL	1
#define	ID_AVC_DAC_CTL_GROUP	2
#define	ID_AVC_DAC_CTL_GROUP_1	3
#define	ID_AVC_DAC_CTL_GROUP_2	4
#define	ID_AVC_DAC_CTL_GROUP_3	5
#define	ID_AVC_DAC_CTL_BUTTON_1	6
#define	ID_AVC_DAC_CTL_BUTTON_2	7
#define	ID_AVC_DAC_CTL_BUTTON_3	8
#define	ID_AVC_DAC_CTL_LABEL_1	9
#define	ID_AVC_DAC_CTL_LABEL_2	10
#define	ID_AVC_DAC_CTL_LABEL_3	11
...
extern D_Result	avc_dac_ctl_window_init  (D_Frame *init) D_FUNCPOSTFIT;
static D_Visual* run_ctrls_avc_dac_ctl_window[12];
D_Frame avc_dac_ctl_window = {
	run_ctrls_avc_dac_ctl_window, 
	ctrl_description_of_avc_dac_ctl_window, 
	avc_dac_ctl_window_init, 
};
