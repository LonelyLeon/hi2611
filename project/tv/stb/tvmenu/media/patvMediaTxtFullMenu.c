...
/*电子书全屏时的位置*/
#define TXT_X_ZOOM_LOCATION		55
#define TXT_Y_ZOOM_LOCATION		69
#define TXT_W_ZOOM_LOCATION	1135
#define TXT_H_ZOOM_LOCATION		589
...
atv_media_txt_full_window_init (D_Frame *frm) D_FUNCPOSTFIT
{
	...
	if(D_OK != d_txt_content_init(media_txt_data->mediaTxtPathName, media_txt_data->x, media_txt_data->y, media_txt_data->w, media_txt_data->h, 0xff000000,24,0,0xff077a41))
	{
