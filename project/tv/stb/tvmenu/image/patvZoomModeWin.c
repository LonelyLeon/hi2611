...
static PREFIXCONST D_CtrlAttribute POSTCONST GUID_fulltrue_left_curr = { -1, atv_IMG_ID_COMB_menu_button_normal_disable, atv_IDS_PTP, &atv_fmt_center_middle_h00_v00_single_white, };
...
atv_zoom_mode_window_handler (D_Visual *vis, D_Event *evt) D_FUNCPOSTFIT
{
    ...
    left_vis = d_frame_get_control (frm, ID_ZOOMMODE_IMAGE_LEFT_ARROW);
    right_vis = d_frame_get_control (frm, ID_ZOOMMODE_IMAGE_RIGHT_ARROW);
