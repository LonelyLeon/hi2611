...
static PREFIXCONST short POSTCONST _atv_IMG_ID_COMB_button_backgroud[]={
	_internal_use_only_IID_HOR, 
	atv_IMG_ID_button_background_left, 
	atv_IMG_ID_button_background_middle, 
	atv_IMG_ID_button_background_right,
};
...
static PREFIXCONST short POSTCONST _atv_IMG_ID_COMB_voice_bar[]={
	_internal_use_only_IID_HOR, 
	atv_IMG_ID_voice_left, 
	atv_IMG_ID_voice_middle, 
	atv_IMG_ID_voice_right,
};
...
static PREFIXCONST short POSTCONST _atv_IMB_ID_COMB_small_window[]={
	_internal_use_only_IID_MAT, 
	atv_IMG_ID_movie_background_lu, 
	atv_IMG_ID_movie_background_mu, 
	atv_IMG_ID_movie_background_ru, 
	atv_IMG_ID_movie_background_lm, 
	atv_IMG_ID_movie_background_middle, 
	atv_IMG_ID_movie_background_rm, 
	atv_IMG_ID_movie_background_ld, 
	atv_IMG_ID_movie_background_md, 
	atv_IMG_ID_movie_background_rd, 
};

static PREFIXCONST short POSTCONST _atv_IMG_ID_COMB_program_info_backplane_narrow[]={
	_internal_use_only_IID_HOR, 
	atv_IMG_ID_program_info_backplane_narrow_L, 
	atv_IMG_ID_program_info_backplane_narrow_M, 
	atv_IMG_ID_program_info_backplane_narrow_R,
};

static PREFIXCONST short POSTCONST _atv_IMG_ID_COMB_program_info_backplane_wide[]={
	_internal_use_only_IID_HOR, 
	atv_IMG_ID_program_info_backplane_wide_L, 
	atv_IMG_ID_program_info_backplane_wide_M, 
	atv_IMG_ID_program_info_backplane_wide_R,
};

static PREFIXCONST short POSTCONST _atv_IMG_ID_COMB_menu_button_normal_disable[]={
	_internal_use_only_IID_HOR, 
	atv_IMG_ID_menu_button_left_disable, 
	atv_IMG_ID_menu_button_normal_disable, 
	atv_IMG_ID_menu_button_right_disable,
};
...
static PREFIXCONST short *POSTCONST img_type_entries[]={
	_atv_IMG_ID_COMB_button_backgroud,
	...
	_atv_IMG_ID_COMB_voice_bar,
	_atv_IMG_ID_COMB_music_select,
	_atv_IMG_ID_COMB_music_select_focus,
	_atv_IMB_ID_COMB_white_background,
	_atv_IMB_ID_COMB_small_window,
	_atv_IMG_ID_COMB_program_info_backplane_narrow,
	_atv_IMG_ID_COMB_program_info_backplane_wide,
	_atv_IMG_ID_COMB_menu_button_normal_disable,
