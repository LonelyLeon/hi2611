...
#define IH_RESERVED_LEN 688 /* 保留688字节 */
#define IH_SIGLEN   272     /* 签名大小, 256+16 */
...
typedef struct image_header {
    ...
    D_U8 ih_reserved[IH_RESERVED_LEN]; /* 保留 */
    D_U8 ih_signature[IH_SIGLEN];	/* 签名		*/
} image_header_t;
