...
#define MAX_SRV_NUM		30
#define MAX_DESC_NUM	12

typedef void(*pfCallBack)(WORD param); 
...
typedef struct
{
	CHAR start_prog_number[4];
	CHAR end_prog_number[4];
}CTI_PPVRecord_t;
...
typedef struct
{
	BYTE ppv_list_page;
	BYTE ppv_prog_count;
	CTI_PPVRecord_t ppv_record[32];
}CTI_PPVListInfoNotify_t;
...
{
	BYTE ippv_list_page;
	BYTE ippv_prog_count;
	CTI_IPPVRecord_t ippv_record[32];
}CTI_IPPVListInfoNotify_t;
//end
*/
