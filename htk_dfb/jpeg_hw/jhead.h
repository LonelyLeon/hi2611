...
typedef struct {
    ...
    int   Whitebalance;
    int   MeteringMode;
    int   ExposureProgram; int   ExposureMode;
    int   ISOequivalent;
    int   LightSource;
    int   DistanceRange;
...
int ReadJpegSections (unsigned char * pic_data, ReadMode_t ReadMode);
void DiscardData(void);
void DiscardAllButExif(void);
int ReadJpegFile(void * pic_data, int data_type, ReadMode_t ReadMode);
